      ...
      >
        ...
        <div className="grid grid-cols-2 gap-6 mt-4">
          <div>
            ...
            <input
              type="date"
              value={form.data_before.date
                ? new Date(form.data_before.date).toISOString().split("T")[0]
                : ""}
              onChange={(e) =>
          ...
          <div>
            ...
            <input
              type="date"
              value={form.data_after.date
                ? new Date(form.data_after.date).toISOString().split("T")[0]
                : ""}
              onChange={(e) =>
